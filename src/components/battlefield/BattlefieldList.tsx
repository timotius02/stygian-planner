...
import { Swords, AlertCircle, Trophy, Target } from 'lucide-react';
...
export function BattlefieldList() {
  return (
    <div className="space-y-6">
      ...
      {/* Info Footer */}
      <div className="mt-6 p-5 rounded-xl bg-gradient-to-r from-slate-800/50 to-slate-900/50 border border-white/10">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-slate-400 leading-relaxed">
              ...
              Plan your teams carefully to maximize your scores across all battlefields.
            </p>
          </div>
        </div>
      </div>
